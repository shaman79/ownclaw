...
public class ThinkingEngine {
    ...
    private String buildSystemPrompt(AgentContext context) {
        ...
        sb.append("  The Python code will be AUTO-GENERATED by a specialized code engine — do NOT include code yourself.\n");
        sb.append("  Your job is to specify WHAT the skill should do, not HOW.\n");
        sb.append("  name (string, required): Lowercase identifier (letters, digits, underscores). E.g. 'web_fetch'\n");
        sb.append("  description (string, required): Detailed description of what the skill does, its expected behavior, ");
        sb.append("edge cases it should handle, and output format. The more detail, the better the generated code.\n");
